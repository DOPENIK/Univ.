...
int main()
{
	...
	DrawRectOutline(Temp,Output, W, H, LU_X, LU_Y, RD_X, RD_Y);

	

	//AverageConv(Image, Output, hInfo.biWidth, hInfo.biHeight); // 평활화를 해준다.

	SaveBMPFile(hf, hInfo, hRGB, Output, hInfo.biWidth, hInfo.biHeight, "pupil2_output.bmp"); // 파일 저장하는 것을 별도의 함수로 짧게 표현했다.
